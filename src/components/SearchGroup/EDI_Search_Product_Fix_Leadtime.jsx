...
function EDI_Search_Product_Fix_Leadtime({ onSearch }) {
    ...
    const fetchProductList = async () => {
        try {
          const response = await axios.get(`http://10.17.100.115:3001/api/smart_edi/filter-product-fix-leadtime`);
...
export default EDI_Search_Product_Fix_Leadtime